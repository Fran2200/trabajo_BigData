...
subtitle: "Francisco Martínez Caballero(franma36@alumni.uv.es)" #- pongo tú nombre ahí para q aparezca más grande q el de la UV
...
Trabajo elaborado para la asignatura "Programación y manejo de datos en la era del Big Data" de la Universitat de València durante el curso 2021-2022. El repo del trabajo está [aquí](https://github.com/Fran2200/trabajo_BigData){target="_blank"}. 
